                      ...
                      <div className="col-md-1">
                        {file.starred === "T" ? (
                          <a
                            ...
                            onClick={() =>
                              this.markStar(index, file.filepath, "F")
                            }
                          >
                          ...
                          <a
                            ...
                            className="link-title "
                            onClick={() =>
                              this.markStar(index, file.filepath, "T")
                            }
                          >
          ...
          <ListGroupItem>
            <Row className="show-grid">
              ...
              <Col md={9}>
                <input
                  ...
                  required="true"
                  autoFocus
                  placeholder="Enter semi-colon separated emails"
                  onChange={(event) => {
                    this.setState({
            ...
            <Row className="show-grid">
              {this.state.showLink === true ? (
                <h6>
                  <small>{this.state.downloadLink}</small>
                </h6>
              ) : (
                ""
              )}
...
export default connect(mapStateToProps, mapDispatchToProps)(FileGridList);
